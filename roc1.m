function [FP,FN,Theta]=roc1(dfce,y)

% This function is from SPRTOOLS, since it was the only one that we
% used on this project, it was easier to copy it and add in our folder, so
% we did not have any incompatibilities with other Matlab's function with
% the same name.
